...
`answers/GitHub Copilot Customization 101/05-pitfalls-quiz/self-check-answers.md`. Write down the letter you choose and
...
- [ ] In the chat you used for the previous exercises, ask: "Summarize the purpose of GitHub Copilot
      Customization 101 in exactly three bullets, using only its README."
