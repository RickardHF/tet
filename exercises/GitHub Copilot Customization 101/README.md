# 👋 Welcome — GitHub Copilot Customization 101

This is your starting point. If you haven't run anything yet, start here — it explains what
this workshop is about, what to expect, and how to get around.
...
- Practical experience choosing an appropriate model and keeping task context focused.
...
1. Complete the repository setup checklist in the [root README](../../README.md#getting-started).
2. **Work through the exercises below, in order** (1 → 5) — each one builds a little on the
...
| 2 | [Build an Agent](02-build-an-agent.md) | Build a doc-writer agent and one of your own design. |
